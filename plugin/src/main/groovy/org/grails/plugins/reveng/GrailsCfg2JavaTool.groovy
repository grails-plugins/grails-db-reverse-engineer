...
class GrailsCfg2JavaTool extends Cfg2JavaTool {
	...
	GrailsCfg2JavaTool(Cfg2HbmTool c2h, MetadataDescriptor metadataDescriptor, Map revengConfig) {
		this.c2h = c2h
	...
	POJOClass getPOJOClass(PersistentClass comp) {
		new GrailsEntityPOJOClass(comp, this, c2h, metadataDescriptor, revengConfig)
	}
}
