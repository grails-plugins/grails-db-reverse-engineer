...
class GrailsEntityPOJOClass extends EntityPOJOClass {
	...
	GrailsEntityPOJOClass(PersistentClass clazz, Cfg2JavaTool cfg, Cfg2HbmTool c2h,
						  MetadataDescriptor metadataDescriptor, Map revengConfig) {
		super(clazz, cfg)
		this.clazz = clazz
		this.c2h = c2h
...
//		}
	...
	String generateImports() {
		...
		if (needsEqualsHashCode()) {
			fixed << delimiter << 'import org.apache.commons.lang3.builder.EqualsBuilder'
			delimiter = newline
			fixed << delimiter << 'import org.apache.commons.lang3.builder.HashCodeBuilder' << delimiter
		}
